...
For platform-specific build-and-install instructions, please refer to [Windows Visual Studio Startup SPA Solution GitHub Wiki Page](Windows-Startup-SPA-Solution) and [Cross-platform Startup SPA Solution GitHub Wiki Page](Cross-platform-Startup-SPA-Solution) respectively.
