...
| Tuple (e.g. <a, p, s>) | In SPA implementation, arrange tuple elements separated by space in a string, and return an array of strings. E.g. Return a list of strings where the first element is 3 First 10, second element is 5 Second 4 etc. On paper, arrange tuple elements seperated by space, and separate tuples by comma. e.g. 3 First 10, 5 Second 4                                    |
